    ...
    try
    {
      ...
      for (int n = 0; n < Buttons.length; n++)
        for (int k = 0; k < Buttons[0].length; k++)
        {
          ...
          Buttons[n][k].setRadioMode(true);
          Buttons[n][k].setBorder(false);
        }

      InterchangeButton = new CGButton(this, ImageContainer.getImage("interchange.gif"), "�������� �������      ");
      add(InterchangeButton);
      InterchangeButton.setName("InterchangeButton");
      InterchangeButton.setActionListener((ActionListener) EventListener);
      InterchangeButton.setBounds(177, 99, 24, 24);
      InterchangeButton.setBorder(false);
      InterchangeButton.setPopUpMode(true);
