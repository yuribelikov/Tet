...
public class C2xVector implements Serializable
{
  ...
  {
    V = new Vector[2];
    V[0] = new Vector(_InitialSize);
    V[1] = new Vector(_InitialSize);
  }

  public void addElement(Object[] _OA)
  {
    V[0].addElement(_OA[0]);
    V[1].addElement(_OA[1]);
  }
  ...
  public void addElements(Object[] _OA1, Object[] _OA2)
  {
    ...
    try
    {
      ...
      {
        V[0].addElement(_OA1[n]);
        V[1].addElement(_OA2[n]);
      }
    }
    catch (Exception e)
    {
  ...
  public Object[] elementAt(int _Pos)
  {
    ...
    {
      oa = new Object[2];
      oa[0] = V[0].elementAt(_Pos);
      oa[1] = V[1].elementAt(_Pos);
      return oa;
    }
    catch (Exception e)
    {
  ...
  {
    V[0].insertElementAt(_OA[0], _Pos);
    V[1].insertElementAt(_OA[1], _Pos);
  }
  ...
  public void removeAllElements()
  {
    try
    {
      V[0].removeAllElements();
      V[1].removeAllElements();
      V[0].trimToSize();
      V[1].trimToSize();
    }
    catch (Exception e)
  ...
  public void removeElementAt(int _N)
  {
    try
    {
      V[0].removeElementAt(_N);
      V[1].removeElementAt(_N);
      V[0].trimToSize();
      V[1].trimToSize();
    }
    catch (Exception e)
  ...
  {
    V[0].setElementAt(_O1, _Pos);
    V[1].setElementAt(_O2, _Pos);
  }
