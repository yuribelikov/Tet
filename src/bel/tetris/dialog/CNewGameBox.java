...
protected void create()
{
 	try
 	{
		...
		PlayerNamesLabels[0]=new Label("��� ������ :"); add(PlayerNamesLabels[0]);
		PlayerNamesLabels[0].setBounds(10, 65, 210, 20);
		PlayerNames[0]=new TextField("����� 1"); add(PlayerNames[0]);
		PlayerNames[0].setBounds(220, 65, W-230, 20);
		PlayerNamesLabels[1]=new Label("��� ������� ������ :"); add(PlayerNamesLabels[1]);
		PlayerNamesLabels[1].setBounds(10, 95, 210, 20); PlayerNamesLabels[1].setVisible(false);
		PlayerNames[1]=new TextField("����� 2"); add(PlayerNames[1]);
