...
public class Log
{
  ...
  private static void out(int _Where, Object _O)
  {
    ...
    switch (_Where)
    {
      ...
      case LOG_TO_CONSOLE:
      {
        if (LogEnabled) System.out.println(str);
        break;
      }
      case LOG_TO_VECTOR:
      {
        if (LogEnabled) toV(str);
        break;
      }

      case ERR_TO_CONSOLE:
      {
        if (ErrOutEnabled) System.out.println(str);
        break;
      }
      case ERR_TO_VECTOR:
      {
        if (ErrOutEnabled) toV(str);
        break;
      }
    }
  }
